...
public enum ResponseCode {
    ...
    NO_QUERY_RESULT(1, "no_query_result"),
    ARGUMENT_ERROR(2, "argument_error"),
    SIGN_CHECK_FAILURE(3, "sign_check_failure"),
    TRANS_AUTH_FAILURE(4, "trans_auth_failure"),
    INTERFACE_COMPATIBALE_ERROR(5, "interface_compatibale_error"),
    OPERATION_FAILURE(6, "operation_failure"),
    EXCEED_COUNT_LIMIT(7, "exceed_count_limit"),
    DUPLICATE_RECORD(8, "duplicate_record"),
    NO_EXIST_RECORD(9, "no_exist_record"),
