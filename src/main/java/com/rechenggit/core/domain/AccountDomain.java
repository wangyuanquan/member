...
import com.rechenggit.core.domain.enums.AccountAttributeEnum;
 ...
 * <p>账户域对象</p>
 * @author chenfei
 * @version $Id: Account.java, v 0.1 2012-11-17 上午11:34:58 cf Exp $
 */
public class AccountDomain implements Serializable {
    ...
    public void setAcctIdentity(String acctIdentity) {
		this.acctIdentity = acctIdentity;
	}
    
    public String getAcctIdentity() {
		return acctIdentity;
	}
